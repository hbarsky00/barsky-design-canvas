  ...
  return (
    <section id="pricing" className="py-20 bg-slate-50">
      <div className="section-container">
        <h2 className="text-3xl font-bold text-left lg:text-center mb-4 font-display">Product Design & AI Development Services</h2>
        ...
        <div className="flex justify-center">
          <Card className="shadow-lg w-full max-w-2xl">
            <CardHeader>
              <h3 className="text-2xl font-bold align-start font-display">Product Design & AI Integration</h3>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-barsky-dark font-display">Product Design</h4>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-barsky-dark font-display">Gen AI Integration & Development</h4>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-barsky-dark font-display">End-to-End Web Development</h4>
