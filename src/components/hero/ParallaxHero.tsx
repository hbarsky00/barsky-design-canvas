        ...
        <div className="parallax-mountains-drift parallax-mountains-back">
          {[0, 1].map((i) => (
            <svg key={i} viewBox="0 0 1200 260" preserveAspectRatio="none">
              ...
              {/* Distant range silhouette */}
              <path
                d="M0,260 L0,170
                   C 60,150 90,135 140,128
                   L 200,90 L 240,118
                   C 290,130 320,118 360,108
                   L 430,60 L 480,98 L 520,82 L 560,112
                   L 640,55 L 700,100 L 740,86
                   L 820,118 L 880,75 L 940,110
                   L 1000,72 L 1060,108 L 1120,92 L 1200,130
                   L 1200,260 Z"
                fill={`url(#mb-grad-${i})`}
              />
              {/* Snow caps */}
              ...
              <path
                d="M0,170 C 60,150 90,135 140,128 L 200,90 L 240,118"
                fill="none" stroke="#3d2654" strokeWidth="1.2" opacity="0.7"
              />
            </svg>
          ))}
        </div>
        <div className="parallax-mountains-drift parallax-mountains-front">
          {[0, 1].map((i) => (
            <svg key={i} viewBox="0 0 1200 260" preserveAspectRatio="none">
              ...
              {/* Foreground jagged peaks */}
              <path
                d="M0,260 L0,200
                   L 80,150 L 130,180 L 180,140 L 230,178
                   L 300,110 L 360,170 L 410,138
                   L 480,180 L 540,118 L 600,168
                   L 680,128 L 740,172 L 800,140
                   L 870,182 L 930,125 L 1000,170
                   L 1070,138 L 1130,178 L 1200,150
                   L 1200,260 Z"
                fill={`url(#mf-grad-${i})`}
              />
              {/* Crisp ridgeline */}
              <path
                d="M0,200 L 80,150 L 130,180 L 180,140 L 230,178
                   L 300,110 L 360,170 L 410,138 L 480,180
                   L 540,118 L 600,168 L 680,128 L 740,172
                   L 800,140 L 870,182 L 930,125 L 1000,170
                   L 1070,138 L 1130,178 L 1200,150"
                fill="none" stroke="#231630" strokeWidth="1.1" opacity="0.9"
              />
