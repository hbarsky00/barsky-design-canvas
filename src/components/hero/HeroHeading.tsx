...
const HeroHeading: React.FC<HeroHeadingProps> = ({
  ...
  return <div className="relative">
      ...
      delay: 1.2
        ...
        <AnimatedText text="15+ Years Experience • 40%+ Conversion Improvements • AI Integration Expert" tag="h2" className="text-lg sm:text-xl font-medium text-gray-700 mb-4 leading-relaxed mx-auto max-w-3xl [text-wrap:balance]" delay={1200} type="word" animation="fade" staggerChildren={0.02} />
