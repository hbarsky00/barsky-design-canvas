    ...
    >
      <div className="max-w-6xl xl:max-w-7xl 2xl:max-w-8xl mx-auto cursor-pointer w-full" onClick={handleNavigateDown}>
        <motion.div
          ...
          className="flex flex-col items-center text-center gap-6 sm:gap-8 xl:gap-12 2xl:gap-16"
        >
          ...
          <div className="order-2">
            <h1 className="text-3xl xs:text-4xl sm:text-5xl lg:text-6xl 
                         ...
                         font-bold text-gray-900 mb-2 sm:mb-3 xl:mb-4 2xl:mb-6 leading-tight">
              Hiram Barsky
            </h1>
            <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl 
                         xl:text-6xl 2xl:text-7xl
                         font-medium text-gray-900 mb-3 sm:mb-4 xl:mb-6 2xl:mb-9">
              Product Designer + AI
            </h2>
            <a 
              ...
              className="text-lg xs:text-xl sm:text-2xl xl:text-4xl 2xl:text-5xl text-blue-600 hover:text-blue-700 
                       transition-colors duration-200 mb-2 xl:mb-4 2xl:mb-6 inline-block font-medium"
        ...
        <motion.div
          ...
          className="flex justify-center items-center space-x-6 sm:space-x-8 xl:space-x-16 2xl:space-x-20
                     mt-6 sm:mt-9 xl:mt-16 2xl:mt-19 order-3"
        >
          <motion.a
          ...
          <motion.a
            ...
            className="p-3 sm:p-4 xl:p-8 2xl:p-10 rounded-xl hover:bg-blue-50 transition-all duration-300
                       min-w-[44px] min-h-[44px] xl:min-w-[80px] xl:min-h-[80px] 2xl:min-h-[100px] 2xl:min-h-[100px]
                       flex items-center justify-center hover:scale-110 hover:shadow-lg"
            whileHover={{ scale: 1.1, y: -2 }}
            whileTap={{ scale: 0.95 }}
            onClick={(e) => e.stopPropagation()}
          ...
          <motion.a
            ...
            onClick={(e) => e.stopPropagation()}
          >
            <Calendar className="h-6 w-6 sm:h-7 sm:w-7 lg:h-8 lg:w-8 xl:h-16 xl:h-16 2xl:h-20 2xl:w-20 
