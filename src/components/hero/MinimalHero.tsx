        ...
        >
          ...
          <div className="order-2">
            ...
            >
              ...
              <div className="text-xl xs:text-2xl sm:text-3xl lg:text-4xl 
                           xl:text-4xl 2xl:text-5xl
                           font-display font-medium bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 
            ...
            >
              <p className="text-lg xs:text-xl sm:text-2xl lg:text-3xl xl:text-3xl 2xl:text-4xl 
            ...
            >
              <p className="text-base sm:text-lg lg:text-xl xl:text-xl 2xl:text-2xl text-gray-700 font-medium">
                Clifton, NJ
              </p>
            </motion.div>
          </div>
