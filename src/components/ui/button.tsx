  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 duration-300 w-full sm:w-auto",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-gray-800 text-white hover:bg-gray-700 active:bg-gray-600 !text-white hover:!text-white active:!text-white [&_svg]:!text-white [&_svg]:!fill-none [&_svg]:!stroke-white [&_svg]:!stroke-2 hover:[&_svg]:!text-white hover:[&_svg]:!fill-none hover:[&_svg]:!stroke-white hover:[&_svg]:!stroke-2 active:[&_svg]:!text-white active:[&_svg]:!fill-none active:[&_svg]:!stroke-white active:[&_svg]:!stroke-2",
