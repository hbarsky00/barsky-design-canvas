  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 duration-300 w-full sm:w-auto",
  {
    variants: {
      variant: {
        ...
        outline:
          "text-blue-600 hover:bg-blue-600 hover:!text-white backdrop-blur-md hover:shadow-xl border border-blue-600 hover:border-blue-600 relative overflow-hidden group [&_svg]:text-blue-600 hover:[&_svg]:!text-white [&_svg]:stroke-blue-600 hover:[&_svg]:!stroke-white [&_svg]:fill-blue-600 hover:[&_svg]:!fill-white [&_svg]:transition-colors [&_svg]:duration-300",
        secondary:
