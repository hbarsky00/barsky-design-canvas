  ...
  return (
    <section id="projects" className="py-20 bg-white">
      <div className="w-full px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6 py-[25px]">
            Case Study Design Portfolio
          </h2>
            ...
            >
              <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 h-full flex flex-col">
                ...
                <div className="relative aspect-[16/10] overflow-hidden">
                  ...
                  {/* Hover Overlay */}
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 w-full h-full">
                    <div className="flex space-x-3 h-full items-center justify-center w-full">
                      <Link
                        to={`/case-studies/${project.id}`}
                        className="bg-white/90 hover:bg-white text-gray-900 px-6 py-3 rounded-lg font-medium transition-colors h-12 flex items-center justify-center"
                      >
                        View Case Study
                      </Link>
                      {project.link && (
                        <a
                          ...
                          className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-medium transition-colors h-12 flex items-center justify-center"
                        >
                ...
                <div className="p-6 space-y-4 flex-1 flex flex-col">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tags.slice(0, 2).map(tag => <Badge key={tag} variant="secondary" className="bg-gray-100 text-gray-700 text-xs">
                        {tag}
                      </Badge>)}
                    {project.tags.length > 2 && <Badge variant="secondary" className="bg-gray-100 text-gray-500 text-xs">
