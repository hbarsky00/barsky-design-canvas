...
const ServicesPreviewSection: React.FC = () => {
  const services = [
    {
      ...
      features: [
        ...
        "User persona development with ChatGPT",
    ...
    },
    {
      ...
      features: [
        "Complete UX research with AI insights",
        "Strategic redesign with optimization",
  ...
  return (
    <section className="py-16 lg:py-24 bg-white" id="services-preview">
