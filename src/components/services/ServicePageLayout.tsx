...
const PROOF = [
  {
    ...
    line: "Same-day pickup sports, designed for trust. Post a game, see open games, confirm in a few taps.",
  },
  {
  ...
  },
  {
    ...
    alt: "HerbaLink herbalist booking app",
    line: "Verified herbalists, designed around trust. A booking platform shipped solo.",
  },
];
