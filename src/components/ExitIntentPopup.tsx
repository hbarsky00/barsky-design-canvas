...
const ExitIntentPopup: React.FC = () => {
  ...
  const benefits = ["AI Integration Opportunity Assessment", "Conversion Rate Optimization Analysis", "Competitive UX Benchmark Report", "Strategic Roadmap for 40%+ Improvement"];
      ...
      backgroundColor: 'rgba(0, 0, 0, 0.75)'
        ...
        stiffness: 300
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6 pt-8 relative text-center">
              <button onClick={handleClose} className="absolute top-4 right-4 text-white hover:text-gray-200 transition-colors">
                <X className="h-6 w-6" />
              </button>
              
              <div className="flex items-center justify-center gap-3 mb-4">
                <Sparkles className="h-8 w-8 text-white" />
                <h2 className="text-2xl font-bold text-white text-center drop-shadow-sm">Wait! Don't Miss This...</h2>
              </div>
            </div>
            ...
            <div className="p-6">
              <div className="text-center mb-6">
                ...
                <div className="relative mb-4">
                  <img src="/lovable-uploads/269c6b35-e093-4302-8658-d446824d8616.png" alt="AI-enhanced app design examples" className="w-full h-32 object-cover rounded-lg shadow-md" />
              ...
              <div className="flex flex-col gap-3">
                ...
                <button onClick={handleClose} className="w-full text-gray-500 hover:text-gray-700 text-sm transition-colors py-2">
