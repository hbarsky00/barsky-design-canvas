          ...
          <nav aria-label="Footer navigation">
            ...
            <ul className="space-y-3" role="list">
              <li>
                <Link 
                  to="/" 
                  className="text-neutral-50 hover:text-blue-vibrant focus:text-blue-vibrant transition-colors duration-300 underline-offset-4 hover:underline focus:underline focus:outline-none focus:ring-2 focus:ring-blue-vibrant focus:ring-offset-2 focus:ring-offset-neutral-900 rounded"
                >
                  Home
                </Link>
              </li>
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-4" role="list">
                <a 
                  ...
                  className="text-neutral-50 hover:text-blue-vibrant focus:text-blue-vibrant transition-colors duration-300 p-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-vibrant focus:ring-offset-2 focus:ring-offset-neutral-900"
