...
const BlogAuthorBio: React.FC<BlogAuthorBioProps> = ({ author }) => {
  return (
    <div className="bg-slate-50 dark:bg-gray-800 rounded-lg p-8 mb-16">
      <h2 className="heading-medium mb-4 text-barsky-dark dark:text-white">About the Author</h2>
      <div className="flex items-center">
        <div className="flex-shrink-0 mr-4">
          <div className="w-16 h-16 rounded-full bg-barsky-blue flex items-center justify-center text-white text-xl heading">
            BD
          </div>
        </div>
        <div>
          <h3 className="heading-medium text-barsky-dark dark:text-white">{author}</h3>
