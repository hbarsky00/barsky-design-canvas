        ...
        <div className="lg:hidden space-y-8">
          ...
          >
            <figure className="project-image-container">
              <img 
                ...
                className="clickable-image w-full h-[400px] object-cover shadow-2xl cursor-pointer transition-transform duration-200 hover:scale-[1.02] rounded-3xl"
          ...
          >
            ...
            <Button 
              size="lg" 
              variant="default" 
              className="font-semibold px-10 py-6 text-lg group bg-blue-600 hover:bg-blue-700" 
          ...
          >
            <figure className="project-image-container">
              <img 
                src="/lovable-uploads/5474d2fe-6139-4e5b-8e46-ccc6e40b7417.png" 
                alt="Splittime co-parenting dashboard with shared calendar integration" 
                className="clickable-image w-full h-[500px] object-cover shadow-2xl cursor-pointer transition-transform duration-200 hover:scale-[1.02] rounded-3xl"
                onClick={() => onImageClick('splittime-hero-1')}
                tabIndex={0}
                onKeyDown={(e) => onImageKeypress(e, 'splittime-hero-1')}
                role="button"
