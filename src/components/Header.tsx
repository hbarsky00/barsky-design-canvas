        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            ...
            {isMobile ? (
              <Link 
                to="/" 
                className="text-xl sm:text-2xl font-script font-medium text-[hsl(var(--blue-accent))] hover:text-[hsl(var(--blue-vibrant))] transition-colors duration-300 relative group whitespace-nowrap pl-3"
              >
                Barsky Design
