      ...
      <div className="max-w-7xl mx-auto pl-2 pr-4 sm:pr-6 lg:pr-8">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-2 justify-start">
            <Link to="/" aria-label="Go to homepage" className="flex items-center gap-3 hover:opacity-80 transition-opacity duration-300">
              ...
              <span className="text-2xl font-bold text-[hsl(var(--blue-accent))]">Barsky Design</span>
            </Link>
          </div>
