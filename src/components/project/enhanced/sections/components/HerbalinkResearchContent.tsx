        ...
        <div>
          ...
          <div className="rounded-xl bg-card border border-border p-4 shadow-sm mb-4">
            <EnhancedContentEditor
              ...
              contentType="section"
              onSave={() => {}}
              images={["/images/herbalink/thought-process.webp"]}
              onImageAdd={(imageSrc) => {
              ...
              projectId={projectId}
              imageCaptions={{
                "/images/herbalink/thought-process.webp": "User research findings and analysis showing key insights from herbalist and patient interviews"
              }}
        ...
        <div>
          ...
          <div className="rounded-xl bg-card border border-border p-4 shadow-sm mb-4">
            <EnhancedContentEditor
              ...
              contentType="section"
              onSave={() => {}}
              images={["/images/herbalink/find-herbalist-sketch.webp"]}
              onImageAdd={(imageSrc) => {
              ...
              projectId={projectId}
              imageCaptions={{
                "/images/herbalink/find-herbalist-sketch.webp": "Competitive analysis of wellness platforms showing market gaps and opportunities for herbalist consultation services"
              }}
              className="rounded-xl shadow-elevated-lg w-full overflow-hidden"
            />
          </div>
        ...
        <div>
          ...
          <div className="rounded-xl bg-card border border-border p-4 shadow-sm mb-4">
            <EnhancedContentEditor
              ...
              contentType="section"
              onSave={() => {}}
              images={["/images/herbalink/sitemap.png"]}
              onImageAdd={(imageSrc) => {
              ...
              projectId={projectId}
              imageCaptions={{
                "/images/herbalink/sitemap.png": "Key research findings highlighting trust and safety requirements for herbal medicine platform design"
              }}
              className="rounded-xl shadow-elevated-lg w-full overflow-hidden"
            />
          </div>
        ...
        <div>
          ...
          <div className="rounded-xl bg-card border border-border p-4 shadow-sm">
            <EnhancedContentEditor
              ...
              contentType="section"
              onSave={() => {}}
              images={["/images/herbalink/herbalist-directory.webp"]}
              onImageAdd={(imageSrc) => {
              ...
              projectId={projectId}
              imageCaptions={{
                "/images/herbalink/herbalist-directory.webp": "Herbalink comprehensive design system emphasizing trust, accessibility, and natural wellness through calming colors and user-friendly typography"
              }}
              className="rounded-xl shadow-elevated-lg w-full overflow-hidden"
            />
          </div>
