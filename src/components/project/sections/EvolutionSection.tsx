  ...
  const phases = [
    {
      ...
      image: "/lovable-uploads/5dbc55b5-23eb-4f33-a9c7-152110769b20.webp",
      color: "green"
    },
    {
      step: "2",
              ...
              <div className="bg-white rounded-xs p-6 shadow-xl border-2 border-gray-100 hover:shadow-2xl transition-all duration-300">
                ...
                {phase.step === "2" ? (
                  ...
                  <MaximizableImage 
                    src={phase.image} 
                    alt={phase.title} 
                    className="w-full h-48 object-cover mb-6 shadow-elevated glass-card layered-depth"
                    imageList={phases.map(p => p.image).filter(Boolean)}
                    currentIndex={index}
                  />
                )}
