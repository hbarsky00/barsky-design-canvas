  ...
  return (
    ...
    >
      ...
      <motion.a
        ...
        className="inline-flex items-center gap-2 px-4 py-3 bg-amber-500 hover:bg-amber-600 text-white font-medium rounded-full shadow-lg hover:shadow-xl transition-all duration-300 group"
