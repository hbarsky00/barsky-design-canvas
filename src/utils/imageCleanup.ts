...
const ACTIVE_IMAGES = [
  '/uploads/8988ca53-0352-4c9a-aa4f-0936db72f7f3.png', // Profile photo
  '/uploads/ffa8416f-51a7-4966-a274-50bf8b2a3c8c.png', // Hero heading
  '/uploads/21ed3f67-cf04-4117-b956-425f6a473789.png', // HerbaLink interface
  '/uploads/eef241e8-8c9a-46bd-a698-6d4cca9880a5.png', // Project hero
  '/uploads/5474d2fe-6139-4e5b-8e46-ccc6e40b7417.png', // SplitTime
  '/uploads/0afc5405-ec7b-4938-a467-96cf505b98d8.png'  // HerbaLink flow
];

// Images that can be removed/replaced (CANDIDATES FOR DELETION)
const UNUSED_IMAGES = [
  '/uploads/e8d40a32-b582-44f6-b417-48bdd5c5b6eb.png',
  '/uploads/e67e58d9-abe3-4159-b57a-fc76a77537eb.png',
  '/uploads/70efa220-d524-4d37-a9de-fbec00205917.png',
  '/uploads/a7f0be86-72db-4c00-86f7-798b641bcf7a.png',
  '/uploads/d5720e5f-50e6-418f-ada9-6b089ae091c1.png',
  '/uploads/9fcd93b1-bcda-4b24-bfc8-f67b544b17ec.png',
  '/uploads/37dc4599-85f2-42b0-b1c9-e1c49c4006c3.png'
];
