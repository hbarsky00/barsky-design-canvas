...
const ACTIVE_IMAGES = [
  ...
  '/images/herbalink/home-hero.webp', // HerbaLink interface
  '/lovable-uploads/eef241e8-8c9a-46bd-a698-6d4cca9880a5.webp', // Project hero
  '/images/herbalink-promo.png', // SplitTime
...
const UNUSED_IMAGES = [
  ...
  '/images/investor-loan-app/hero.webp',
  '/images/investor-loan-app/loan-officer.webp',
