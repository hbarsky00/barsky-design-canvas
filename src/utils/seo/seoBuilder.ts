...
export type BuiltSEO = {
  title: string; description: string; canonical: string; type: "website" | "article";
  siteName?: string; robots?: string;
  ...
  author?: string; tags?: string[]; publishedTime?: string; modifiedTime?: string;
};
