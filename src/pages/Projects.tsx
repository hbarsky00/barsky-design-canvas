...
const Projects = () => {
  ...
  return (
    <>
      <DynamicSeo 
        type="page"
        title="Product Design & Gen AI Portfolio | Hiram Barsky - AI-Powered Web Applications"
        ...
        keywords={["Product Design", "Gen AI", "AI-Powered", "Web Applications", "UX Design", "Portfolio"]}
