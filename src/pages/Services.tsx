...
import { Calendar, PenLine, Users, Clock, Briefcase } from "lucide-react";
...
const Services = () => {
  ...
  React.useEffect(() => {
    trackPageView('/services', 'Services - Hiram Barsky');
  }, []);

  return (
    <div className="flex flex-col min-h-screen overflow-x-hidden">
      <Helmet>
        <title>Services | Hiram Barsky | Product Designer & Developer</title>
        <meta name="description" content="Professional design and development services offered by Hiram Barsky, including product design, UX/UI consultation, and development services." />
      ...
      <main className="flex-grow pt-24">
        <section className="py-20 bg-slate-50">
          <div className="section-container">
            <h1 className="text-3xl font-bold text-center mb-4">My Design Services</h1>
