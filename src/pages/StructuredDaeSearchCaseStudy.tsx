    ...
    blocks={[
      {
        ...
        images: [
          { src: "/images/dae-search/the-problem.webp", alt: "DAE dashboard with recommended search terms surfacing on query" },
        ],
      },
      {
        ...
        images: [
          { src: "/images/dae-search/decisions-2.webp", alt: "Filterable data catalog results with therapeutic area, geography, and availability" },
        ],
      },
      {
        ...
        images: [
          { src: "/images/dae-search/what-i-built.webp", alt: "DAE Search process flow from login through related-content discovery" },
          { src: "/images/dae-search/decisions-1.webp", alt: "Early hand-drawn wireframes for advanced search, entity selection, and results" },
        ],
      },
      {
        ...
        images: [
          { src: "/images/dae-search/hero.webp", alt: "Reference board of dense enterprise patterns informing the redesign" },
        ],
      },
      {
        heading: "Outcome",
