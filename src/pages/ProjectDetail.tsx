...
const projectImageCaptions: Record<string, Record<string, string>> = {
  ...
  "barskyjoint": {
    ...
    "/lovable-uploads/a566ef85-3556-47c1-9175-16aaa0ec4e44.png": "Core App Features - Menu browsing with easy navigation, streamlined order placement, real-time truck tracking, and exclusive offers for app users",
    "/lovable-uploads/2bd2eddc-5394-4d81-890a-57eaa00a7ed3.png": "Sketching Phase: Concept Development - Hand-drawn wireframes exploring initial ideas with multiple iterations testing different approaches",
    ...
    "/lovable-uploads/b53965c1-86f3-479d-a37c-9395c184fb2d.png": "The Barsky Joint website homepage showcasing their signature items and gourmet burger menu with delivery capabilities"
  },
  "spectrum": {
