    ...
    blocks={[
      {
        ...
        images: [
          {
            src: "/images/email-creation-ai/fig-who-owns-each-step.svg",
            alt: "Two lanes, a person and the model: the writer edits, the model assembles content and compliance blocks, Content Ops and Med Writer sign off, the model generates HTML and runs the checklist, Send Preview to Brand appears once it passes, MLR review not designed",
