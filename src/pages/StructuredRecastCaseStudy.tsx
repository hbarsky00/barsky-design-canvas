...
const StructuredRecastCaseStudy: React.FC = () => (
  <SimpleCaseStudyPage
    ...
    heroImage={{
      src: "/images/recast/card-footage.webp",
    ...
    blocks={[
      {
        ...
        images: [
          {
            src: "/images/recast/fig-the-boundary.svg",
            alt: "Two panels: the app records, plays the local file on stop and uploads in the background; the website holds the library, playback and share links and never records. One arrow between them carries the finished file",
