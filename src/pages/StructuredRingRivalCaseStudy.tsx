    ...
    blocks={[
      {
        ...
        image: { src: "/images/ringrival-controls-modal.png", alt: "VS Glass Joe — controls modal with input scheme" },
      },
      {
        ...
        image: { src: "/images/ringrival-vonkaiser.png", alt: "Von Kaiser — tall, broad, defensive guard" },
      },
      {
        ...
        image: { src: "/images/ringrival-knockdown.png", alt: "Knockdown — DOWN! 5-count with star burst" },
      },
      {
        heading: "What Got Cut",
        paragraphs: [
          "Time-to-first-punch dropped from 22 seconds to 6 by cutting menus and tutorial screens.",
          "Audio failure rate dropped from ~40% to under 2% by gating AudioContext behind the first tap. Webcam hand-tracking was technically impressive and completely wrong for the audience — removed entirely.",
        ],
        image: { src: "/images/ringrival-impact-particles.png", alt: "Glass Joe impact particles" },
      },
      {
        heading: "Outcome",
        paragraphs: [
          "A shipped boxing game with a 3–6 build-per-day cadence, real user cuts, and AI opponents that bait, hesitate, and tilt based on how the player is doing.",
