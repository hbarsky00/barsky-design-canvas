  ...
  <SimpleCaseStudyPage
    ...
    blocks={[
      ...
      },
      {
        ...
        images: [
          {
            src: "/images/ring-rival/fig-one-rig.svg",
            alt: "A shared rig of body, arms, legs and head, a per-fighter proportions and nine-pose sheet, and nine pose slots: eight the fight code counts on and one special",
