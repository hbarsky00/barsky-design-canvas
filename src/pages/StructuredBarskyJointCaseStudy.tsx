  ...
  <SimpleCaseStudyPage
    ...
    blocks={[
      ...
      },
      {
        ...
        paragraphs: [
          "Every item ships with a sensible default — two taps and you're done, customize inline if you want.",
          "Same components on kiosk and web, with tap targets sized for thumbs vs. cursors: one design system, calibrated per device.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "No post-launch numbers I'd stand behind — but the principle holds: defaults do more work than options.",
        ],
      },
    ]}
  />
