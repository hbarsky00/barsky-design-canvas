          ...
          <section className="py-20 bg-gradient-to-r from-blue-500 via-indigo-500 to-blue-600">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              duration: 0.8
                ...
                <Button size="lg" variant="default" className="font-semibold px-10 py-6 text-lg group bg-white text-blue-600 hover:bg-blue-50" onClick={() => window.location.href = '/contact'}>
