...
const StructuredBusinessManagementCaseStudy: React.FC = () => {
  const seoProps = {
    title: 'Business Management Platform - Enterprise Software Case Study',
    description: 'UX design case study for a comprehensive business management platform featuring advanced analytics and workflow automation.',
    image: '/lovable-uploads/a4f7c8e1-2d9b-4c3f-8a7e-9d1c2b3a4f5e.png',
    projectName: 'Business Management Platform'
  };
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <ProjectImage
              ...
              alt="Business Management Platform Interface"
