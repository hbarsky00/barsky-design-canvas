...
export const structuredCaseStudies: Record<string, StructuredCaseStudyData> = {
  "firelion": {
    ...
    narrativeBlocks: [
      { type: "hook", text: `A one-tap arcade runner where you spell words mid-flight to cast spells. Built solo with AI.` },
      { type: "divider" },
      { type: "header", text: `The problem` },
      { type: "paragraph", text: `Most "I built X with AI" portfolios are a calculator or a dashboard. Safe. Forgettable. I wanted the hardest answer to "can a designer ship real product solo with AI?" — a game. You can't fake game feel with a prompt.` },
      { type: "divider" },
      { type: "header", text: `What I built first` },
      { type: "paragraph", text: `One tap. One lion. No words, no worlds, no audio. Just: does the tap-to-fly feel good?` },
      { type: "image", src: `/images/firelion-gameplay-lavagod.png`, alt: `Main runner gameplay, Lava God form, Wave 5, invincibility power-up` },
      { type: "divider" },
      { type: "header", text: `The mechanic` },
      { type: "paragraph", text: `Spell words mid-flight. Complete words cast spells.` },
      ...
      { type: "divider" },
      { type: "header", text: `What AI did` },
      { type: "paragraph", text: `Scaffolding. Tailwind tokens. Supabase schemas. Canvas collision math. Particle systems. Refactors across 30+ files in one pass. Procedural chiptune. A pre-commit script that fails the build if any sprite ships with a white matte halo.` },
      { type: "divider" },
      { type: "header", text: `What I judged` },
      { type: "paragraph", text: `What the game is. Game feel — every gravity tweak and tap impulse, hand-tuned over hundreds of runs. The visual identity. And the thing AI can't do: what to delete.` },
      { type: "divider" },
      { type: "header", text: `The deletion list got longer than the feature list` },
      { type: "bullets", items: [
        `Daily missions — nobody completed them`,
      ...
      { type: "paragraph", text: `Building features is easy with AI. Killing features is the actual design work.` },
      { type: "divider" },
      { type: "header", text: `Lion Wars` },
      { type: "paragraph", text: `A naval combat side-game that originally triggered between worlds. Players hated being yanked out of flow. Pulled the trigger entirely. Code stays for Phase 2.` },
      { type: "image", src: `/images/firelion-lionwars-combat.png`, alt: `Lion Wars naval combat, wave 1 of 7, lava cavern backdrop` },
      { type: "divider" },
      { type: "header", text: `Cub Mode` },
      { type: "paragraph", text: `A separate top-down stomp game for a baby lion. One rule, enforced in the AI memory file: Cub Mode is never touched by main game changes. Separate component, separate audio, separate state.` },
      { type: "image-pair", images: [
      ...
      { type: "divider" },
      { type: "header", text: `Outcome` },
      { type: "paragraph", text: `Three modes, three moods. A shipped game. A deletion list longer than its feature list. Self-playtested daily.` },
      { type: "paragraph", text: `The thesis: AI can scaffold a game in a week. Deciding which 80% to throw away is the year of work that makes it playable.` },
      { type: "divider" },
      { type: "header", text: `What's next` },
      { type: "bullets", items: [
        `Integrate Lion Wars into the main runner from World 5 onward`,
        `Capacitor wrapper for the App Store`,
        `Real event telemetry`,
        `Async ghost runs against a friend's best`,
      ]},
    ],
    problemCallout: {
      eyebrow: `THE PROBLEM`,
  ...
  "ring-rival": {
    ...
    narrativeBlocks: [
      { type: "hook", text: `A retro arcade boxing game for the mobile browser. Distinct AI opponents, AI-generated trash talk, career mode. Built solo.` },
      { type: "divider" },
      { type: "header", text: `The problem` },
      { type: "paragraph", text: `Boxing games live on consoles for a reason. Tight input latency, animation feel, AI that reads like a real opponent. Doing all that with a thumb on a phone — in a browser, no install — was the constraint that made it interesting.` },
      { type: "divider" },
      { type: "header", text: `What I built first` },
      { type: "paragraph", text: `One opponent. Two buttons. A health bar. Can a punch feel good on a phone screen?` },
      { type: "image", src: `/images/ringrival-glassjoe-idle.png`, alt: `Glass Joe idle stance, the v1 starter opponent` },
      { type: "divider" },
      { type: "header", text: `The controls` },
      { type: "paragraph", text: `Tap, swipe, two-finger block, dodge-then-punch for a 2× counter. Five seconds before each fight, then dismiss.` },
      { type: "image", src: `/images/ringrival-controls-modal.png`, alt: `VS Glass Joe controls modal with input scheme` },
      { type: "divider" },
      { type: "header", text: `What AI did` },
      { type: "paragraph", text: `Sprite generation via Gemini — weeks of pixel art became a prompt loop. In-character trash talk per opponent and per fight state. Announcer intros. Crowd mood that modulates with round momentum. An EmotionEngine where opponents bait, hesitate, and tilt.` },
      { type: "image-pair", images: [
      ...
      { type: "paragraph", text: `Each fighter has a voice without me writing a dialogue tree.` },
      { type: "divider" },
      { type: "header", text: `What I judged` },
      { type: "paragraph", text: `Game feel. No model knows whether a punch feels like a punch — hit-stop duration, screen shake, the 60ms haptic on connect. Hundreds of test fights.` },
      { type: "image", src: `/images/ringrival-knockdown.png`, alt: `Knockdown — DOWN! 5 count with star burst over floored Glass Joe` },
      { type: "paragraph", text: `The difficulty order. AI generates fighters endlessly; sequencing them is design. Where the punch button lives on a real phone in a real hand.` },
      { type: "divider" },
      { type: "header", text: `Particle effects` },
      { type: "paragraph", text: `Bald Bull's signature charge spawned 15 dust particles per frame. On mobile it was a cloud you couldn't see through. Throttled to 15% of frames.` },
      { type: "image", src: `/images/ringrival-impact-particles.png`, alt: `Glass Joe getting hit, red impact particles dialed back so fighter stays visible` },
      { type: "divider" },
      { type: "header", text: `What broke` },
      { type: "bullets", items: [
        `Sprite scaling. Three rebuilds before per-archetype mobileScaleBoost multipliers worked across body types.`,
      ...
      { type: "image", src: `/images/ringrival-pause-modal.png`, alt: `Pause modal mid-fight vs. Disco Dan` },
      { type: "divider" },
      { type: "header", text: `What users ignored` },
      { type: "paragraph", text: `The 4-step calibration wizard. The daily challenges modal (<5% click-through). The how-to page (zero of six testers opened it before their first fight).` },
      { type: "paragraph", text: `If the first fight doesn't teach the controls in 10 seconds, no static screen will rescue it.` },
      { type: "divider" },
      { type: "header", text: `Outcome` },
      { type: "paragraph", text: `Time-to-first-punch: 22 seconds → 6 seconds. Audio failure rate: ~40% → under 2%. Most days: ship, watch one session, fix the loudest thing, reship. Three to six deploys daily.` },
      { type: "divider" },
      { type: "header", text: `What's next` },
      { type: "bullets", items: [
        `Tutorial fight, not a tutorial screen`,
        `Async PvP — record a player's fight as an AI ghost`,
        `Belt animations + meta-progression that survives between sessions`,
        `Accessibility pass (color-blind telegraphs, reduce-flash, larger tap targets)`,
  ...
  "catchbuddy": {
    ...
    narrativeBlocks: [
      { type: "hook", text: `A location-aware web app for finding a partner for pickup sports nearby. Post a game, browse open games, confirm in a few taps. Built solo with AI.` },
      { type: "divider" },
      { type: "header", text: `The problem` },
      { type: "paragraph", text: `Pickup sports are dying in cities. Existing apps are league-focused or chat-heavy. Nobody wants a Slack thread to throw a baseball after work.` },
      { type: "divider" },
      { type: "header", text: `What I built first` },
      { type: "paragraph", text: `A single screen: post a game, see open games on a map. No auth. No chat. No profiles. Can two strangers agree on a park and a time?` },
      { type: "image", src: `/images/catchbuddy-signin.png`, alt: `Sign-in screen with the CatchBuddy brand` },
      { type: "divider" },
      { type: "header", text: `The core flow` },
      { type: "paragraph", text: `Pick a sport. Pick a park. Pick a time. Post.` },
      { type: "image-pair", images: [
      ...
      { type: "divider" },
      { type: "header", text: `What AI did` },
      { type: "paragraph", text: `RLS-safe Postgres schemas. The profiles_public view that limits other users' visible columns. Supabase migrations. The proximity + time match heuristic powering the % scores below. Stripe Checkout, Google Calendar OAuth, phone verification, safety check-in monitoring. Security code review that caught a recursive RLS policy I would have shipped.` },
      { type: "image", src: `/images/catchbuddy-find-players.png`, alt: `Find Players list with 92% and 81% match scores` },
      { type: "divider" },
      { type: "header", text: `What I judged` },
      { type: "paragraph", text: `The trust and safety model. Minors require a verified parent on file. The panic button reaches every in-game screen. Public meeting spots are curated, not crowdsourced. None of that comes from a prompt.` },
      { type: "image", src: `/images/catchbuddy-signup-minor-gate.png`, alt: `Sign-up form with the 13+ age gate` },
      { type: "paragraph", text: `Also: monetization tiers, the demo-data toggle for first-time visitors, and the terminology — "Browse" and "Players" instead of "Matches," because "Matches" tested as Tinder-like.` },
      { type: "image", src: `/images/catchbuddy-pro-pricing.png`, alt: `Pro pricing — $7.99/mo or $59.99/yr` },
      { type: "divider" },
      { type: "header", text: `What broke` },
      { type: "bullets", items: [
        `The Quick Start wizard. Watched users skip it every time. Cut.`,
      ...
      { type: "divider" },
      { type: "header", text: `Outcome` },
      { type: "paragraph", text: `Real shipped app with auth, RLS, OAuth, Stripe payments, realtime, minor-approval flow, geolocation, multi-sport scope. Mobile-first.` },
      { type: "paragraph", text: `The thesis: safety can't be a bolt-on. If you're building a product where strangers meet in person, the trust model is the product. AI scaffolds the schema. It doesn't decide whether a 17-year-old needs a verified parent before they can post.` },
      { type: "divider" },
      { type: "header", text: `What's next` },
      { type: "bullets", items: [
        `Native shells for push notifications and background safety check-ins`,
        `Park-anchored micro-groups, weekly "regulars" leaderboard`,
        `Recurring weekly games`,
        `A reputation graph beyond show-up rate`,
        `Stripe Connect for optional pro coaches`,
      ]},
    ],
    problemCallout: {
      eyebrow: `THE PROBLEM`,
  ...
  "herbalink": {
    ...
    narrativeBlocks: [
      { type: "hook", text: `A booking platform for verified herbalists. Designed and shipped solo with AI as a co-builder. Built around the realization that the product isn't search — it's trust.` },
      { type: "divider" },
      { type: "header", text: `The problem` },
      { type: "paragraph", text: `People are turning to herbalism for anxiety, fatigue, conditions conventional medicine isn't addressing for them. The discovery experience is a mess: Instagram practitioners with no credentials, Google results that mix certified herbalists with people who took a weekend workshop, supplements that interact dangerously with prescription medication.` },
      { type: "paragraph", text: `One quote from research stuck with me: "I found this herbalist on Instagram who promised to cure my anxiety with a $200 tincture. Turns out she had zero credentials and the herbs made me violently sick."` },
      { type: "paragraph", text: `That's not a search problem. It's a trust and safety problem.` },
      { type: "divider" },
      { type: "header", text: `What I built first` },
      { type: "paragraph", text: `A giant filterable database of every herbalist I could find. Sport, modality, condition, location, price, availability — all the filters. It was the wrong product.` },
      { type: "image-pair", images: [
      ...
      { type: "divider" },
      { type: "header", text: `What AI did` },
      { type: "paragraph", text: `Component scaffolding, the Supabase schema, RLS policies, edge functions for booking and notifications. Drafting the symptom intake question structure. Writing the boilerplate copy for empty states. Generating the practitioner profile layout variants I A/B'd against each other.` },
      { type: "image", src: `https://barskyux.com/wp-content/uploads/2025/08/ChatGPT-Image-Aug-19-2025-11_19_58-PM.png`, alt: `User flow explorations` },
      { type: "divider" },
      { type: "header", text: `What I judged` },
      { type: "paragraph", text: `The credential-verification model. AI doesn't know what the American Herbalists Guild is, doesn't know which certifications matter for which conditions, doesn't know that "verified" as a badge on a Yelp-style profile is meaningfully different from "verified" as a gate that controls whether you appear at all. That distinction is the entire product.` },
      { type: "image", src: `https://i0.wp.com/barskyux.com/wp-content/uploads/2025/07/UserFlow.png?fit=1232%2C928&ssl=1`, alt: `HerbaLink user flow from onboarding to booking` },
      { type: "divider" },
      { type: "header", text: `Hiccup` },
      { type: "paragraph", text: `The giant filterable database was the wrong product. Testing the filter-heavy version was brutal. One user said: "This feels like trying to diagnose myself on WebMD." They didn't want to filter. They wanted to describe what was wrong and be matched. Redesigned closer to a triage intake than a search bar.` },
      { type: "paragraph", text: `When users say they want more options, they often mean they want more confidence in the option they pick. Adding 200 practitioners made things worse, not better.` },
      { type: "paragraph", text: `The comprehensive symptom tracker. Started as a health diary with mood, sleep, supplements, side effects, energy levels. Users opened it twice and abandoned it. Cut it back to one question: "what changed since last visit?" That one they use.` },
      { type: "paragraph", text: `"Verified" as a badge instead of a gate. First version let anyone list themselves and slapped a badge on profiles that passed a basic check. Inverted the whole thing: practitioners aren't visible at all until credentials are checked against the American Herbalists Guild or equivalent. No unverified tier. Smaller catalog, more honest one.` },
      { type: "divider" },
      { type: "header", text: `Outcome` },
      { type: "paragraph", text: `Early users described it as feeling more like booking a doctor than browsing a wellness app. That was the shift I was after.` },
      { type: "paragraph", text: `The thesis: in a category dominated by misinformation, the design job is to make the safe path the easy path. Not to add warnings to the unsafe path. AI can build the directory in a weekend. Deciding who doesn't appear in it is the actual product.` },
      { type: "divider" },
      { type: "header", text: `What's next` },
      { type: "bullets", items: [
        `Practitioner-side tools — calendar management, intake review, secure messaging with attachments`,
        `A medication-interaction checker on the booking page that pulls from a real pharmacology database`,
        `A follow-up flow that prompts "what changed since last visit?" 7 days post-appointment`,
      ]},
    ],
    problemCallout: {
      eyebrow: `THE PROBLEM`,
