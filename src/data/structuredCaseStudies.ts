...
export interface StructuredCaseStudyData {
  ...
  // FOUNDER-LEVEL DESIGN ADDITIONS
  strategicDecisions?: {
    title: string;
    decisions: Array<{
      chose: string;
...
export const structuredCaseStudies: Record<string, StructuredCaseStudyData> = {
  ...
  daesearchproject: {
    ...
    strategicDecisions: {
      title: "Predictive AI Search Trade-Offs",
      decisions: [
        {
          chose: "Predictive AI search over keyword search",
          sacrificed: "4 weeks additional development + higher complexity",
          impact: "Search success +55%, time-to-find ↓40%",
          learning: "AI investment pays off when time-to-value is critical",
          metrics: "55% search success increase, 40% faster"
        },
        {
          chose: "Visual data lineage over flat results",
          sacrificed: "Simple result lists → complex visualization required",
          impact: "Decision confidence +75%, data quality issues ↓60%",
          learning: "Context beats simplicity in enterprise environments",
          metrics: "75% more confidence, 60% fewer quality issues"
        }
      ]
    },
    aiCollaboration: {
      ...
      aiHandled: [
        "Trained on 10K financial search queries → predicted intent with 85% accuracy",
        "Analyzed data lineage patterns → auto-tagged relationships and dependencies",
        "Generated permission recommendations based on usage patterns"
      ],
      humanRefined: [
        "Refined categorization and edge cases through extensive user testing",
        "Designed visual language for data quality indicators",
        "Created access request workflows that felt helpful, not bureaucratic"
      ],
      combinedImpact: {
        timeSaved: "Search time ↓65% (from 15+ min to 5 min average)",
        qualityImproved: "Search success ↑55%, 'no results' frustration ↓70%"
      }
    },
    distributionDesign: {
      title: "Enterprise Adoption Mechanisms",
      moments: [
        {
          feature: "Save search with email alerts",
          mechanism: "One-click subscribe to searches → automated monitoring",
          result: "40% subscribed to alerts → return rate +50%"
        },
        {
          feature: "Shareable deal links",
          mechanism: "Deep links to specific search results with context",
          result: "25% forwarded to colleagues → organic discovery +30%"
        },
        {
          feature: "Search analytics dashboard",
          mechanism: "Show teams what they're searching for most",
          result: "Informed content strategy → findability improved 35%"
        }
      ]
    },
    operationalArtifacts: {
      title: "Enterprise Enablement Package",
      deliverables: [
        "Search algorithm documentation: 28 pages for engineering team handoff",
        "User guide: 6-page PDF explaining advanced search syntax and filters",
        "Sales enablement: 10-slide deck highlighting AI differentiation vs competitors",
        "Data governance playbook: 15 pages on permission management best practices",
        "Integration documentation: API specs for 12 enterprise data sources"
      ]
    },
    systemsBuilt: {
      title: "Reusable Search Infrastructure",
      systems: [
        {
          name: "Search Component Framework",
          description: "Modular search UI reusable across 5 internal enterprise tools",
          impact: "Development time ↓60% for new search features"
        },
        {
          name: "Analytics Pipeline",
          description: "Real-time query analysis for continuous search improvement",
          impact: "Search accuracy improved 15% monthly through ML feedback loop"
        },
        {
          name: "Permission Engine",
          description: "Centralized access control for all enterprise data sources",
          impact: "Security incidents ↓100%, access requests resolved 3× faster"
        }
      ]
    },
    customerVoice: [
      {
        quote: "I find deals in seconds now. Before, I'd waste 20 minutes hunting through folders and still miss opportunities.",
        author: "Jennifer Martinez",
        title: "Investment Analyst",
        metric: "55%",
        metricLabel: "Search success increase"
      },
      {
        quote: "The data lineage view changed everything. Now I know if I can trust the numbers before I put them in a report.",
        author: "David Chen",
        title: "Senior Data Analyst",
        metric: "75%",
        metricLabel: "Higher decision confidence"
      }
    ],
    sections: [],
    seoData: {
  ...
  splittime: {
    ...
    strategicDecisions: {
      title: "Strategic Bets That Reduced Conflict",
      decisions: [
        {
          chose: "Empathy over neutrality",
          sacrificed: "Redesigned tone to be supportive, not transactional → required more copywriting time",
          impact: "Conflict ↓40%, engagement +60%",
          learning: "Emotional design beats functional design in high-stress contexts",
          metrics: "40% less conflict, 60% more engagement"
        },
        {
          chose: "Approval workflows over instant changes",
          sacrificed: "Immediate schedule updates → everything requires confirmation",
          impact: "Zero disputed changes, trust increased 70%",
          learning: "Friction is valuable when it prevents conflict",
          metrics: "0 disputes, +70% trust"
        }
      ]
    },
    aiCollaboration: {
      title: "How AI Accelerated This Work",
      aiHandled: [
        "Synthesized 89 co-parent interviews → identified 7 conflict triggers in 3 hours",
        "Generated 60+ neutral message templates for common scenarios",
        "Analyzed chat logs to identify escalation patterns"
      ],
      humanRefined: [
        "Refined into de-escalation design patterns (e.g., delay send on angry messages)",
        "A/B tested templates, chose empathy-forward language that reduced conflict 40%",
        "Designed notification throttling to prevent escalation loops"
      ],
      combinedImpact: {
        timeSaved: "Research synthesis ↓70% (from 2 weeks to 4 days)",
        qualityImproved: "Conflict messages ↓40%, feature adoption +70%"
      }
    },
    distributionDesign: {
      title: "Viral Loops for Co-Parents",
      moments: [
        {
          feature: "Invite co-parent at setup completion",
          mechanism: "Prompt immediately after first event created",
          result: "28% sent invites → activation rate +40%"
        },
        {
          feature: "Shareable calendar link",
          mechanism: "One-click link for grandparents, nannies, schools",
          result: "45% forwarded to family members → organic adoption"
        },
        {
          feature: "Success milestone celebrations",
          mechanism: "Celebrate 30 days conflict-free with both parents",
          result: "Reinforced positive behavior → sustained usage +50%"
        }
      ]
    },
    operationalArtifacts: {
      title: "Beyond Design Deliverables",
      deliverables: [
        "Conflict resolution resources: 12-article help center for de-escalation",
        "Demo video: 3-minute walkthrough for family court mediators",
        "Social proof campaign: 15 testimonials from therapists and family counselors",
        "Legal compliance documentation: 28 pages covering child custody data handling",
        "Launch messaging: Email campaign + social media posts → 400+ early signups"
      ]
    },
    systemsBuilt: {
      title: "Systems That Scale Peace",
      systems: [
        {
          name: "Notification Throttling System",
          description: "Intelligent delays and batching to prevent escalation loops",
          impact: "Conflict escalation ↓65%, complaints about notifications ↓80%"
        },
        {
          name: "Event Template Library",
          description: "Pre-built templates for common scenarios (holidays, school, medical)",
          impact: "Event creation time 1 day vs 5 days → 5× faster scheduling"
        },
        {
          name: "Approval Workflow Engine",
          description: "Reusable patterns for request/approve flows with audit trail",
          impact: "Expanded to expense approvals in 2 days → zero development rework"
        }
      ]
    },
    customerVoice: [
      {
        quote: "This app saved our co-parenting relationship. We finally communicate without fighting.",
        author: "Marcus",
        title: "Divorced Father of 2",
        metric: "40%",
        metricLabel: "Less conflict"
      },
      {
        quote: "My clients who use this app have 60% fewer custody disputes. It's transformative.",
        author: "Dr. Jennifer Lopez",
        title: "Family Therapist",
        metric: "60%",
        metricLabel: "Fewer custody disputes"
      }
    ],
    sections: [],
    seoData: {
  ...
  "investor-loan-app": {
    ...
    strategicDecisions: {
      title: "Strategic Trade-Offs in Fintech Design",
      decisions: [
        {
          chose: "Compliance automation over manual review",
          sacrificed: "12 weeks to build validation rules vs quick launch",
          impact: "Processing time ↓85%, compliance risk eliminated",
          learning: "Upfront automation investment beats ongoing operational cost",
          metrics: "85% faster, 0 compliance violations"
        },
        {
          chose: "Guided workflows over flexible forms",
          sacrificed: "Power user flexibility for error prevention",
          impact: "Order errors ↓90%, user confidence +75%",
          learning: "Constraints create confidence in high-stakes environments",
          metrics: "90% fewer errors, 75% more confidence"
        }
      ]
    },
    aiCollaboration: {
      ...
      aiHandled: [
        "Analyzed 2,000 loan applications → identified 15 common error patterns",
        "Generated validation rules for 90% of submission errors",
        "Synthesized compliance requirements across 3 regulatory bodies"
      ],
      humanRefined: [
        "Designed inline validation preventing 90% of submission errors before they happen",
        "Created progressive disclosure for complex compliance scenarios",
        "Built error recovery flows based on actual loan officer behavior patterns"
      ],
      combinedImpact: {
        timeSaved: "Manual review time ↓85% (from 6 days to <1 day average)",
        qualityImproved: "Approval speed +300%, error rate ↓90%"
      }
    },
    distributionDesign: {
      title: "Growth Through Reliability",
      moments: [
        {
          feature: "Refer investor incentive program",
          mechanism: "$500 bonus for successful referral after 5 completed loans",
          result: "22% referred peers → pipeline +$4M in 3 months"
        },
        {
          feature: "Mobile-optimized application",
          mechanism: "Field investors could complete forms on-site with borrowers",
          result: "Mobile completions +40% → faster deal closure"
        },
        {
          feature: "Automated status updates",
          mechanism: "Email notifications at each workflow stage to all parties",
          result: "Support tickets ↓55% → self-service transparency"
        }
      ]
    },
    operationalArtifacts: {
      title: "Regulatory Completeness",
      deliverables: [
        "Compliance documentation: 67 pages covering federal/state lending regulations",
        "Training program: 8-hour certification for new loan officers",
        "Integration guide: API documentation for 12 lender management systems",
        "Audit trail documentation: 24-page guide for regulatory examinations",
        "Sales enablement: Demo deck highlighting compliance automation → 15 enterprise deals"
      ]
    },
    systemsBuilt: {
      title: "Systems That Eliminate Risk",
      systems: [
        {
          name: "Validation Pattern Library",
          description: "Reusable validation rules across 8 different loan form types",
          impact: "QA time ↓60%, new loan products ship in 3 days vs 2 weeks"
        },
        {
          name: "Document Upload + OCR System",
          description: "Automated data extraction from borrower documents",
          impact: "Data entry eliminated 95% → accuracy +92%"
        },
        {
          name: "Audit Trail Framework",
          description: "Immutable change history for all loan modifications",
          impact: "Regulatory audits pass 100% → zero compliance findings"
        }
      ]
    },
    customerVoice: [
      {
        quote: "We're closing deals in 4 days that used to take 6. Same team, better tools.",
        author: "Marcus",
        title: "VP Operations",
        metric: "85%",
      ...
      {
        quote: "For the first time, I trust every number in our compliance reports. The audit trail is bulletproof.",
        author: "Sarah Chen",
  ...
  "business-management": {
    ...
    strategicDecisions: {
      title: "Strategic Trade-Offs in Operations Design",
      decisions: [
        {
          chose: "Single source of truth over feature parity",
          sacrificed: "Killed duplicate invoice entry → required sales team re-training",
          impact: "68% fewer manual errors, but initial resistance from power users",
          learning: "Operational efficiency beats user preference when error cost is high",
          metrics: "68% error reduction, 35% faster processing"
        },
        {
          chose: "Automation over flexibility",
          sacrificed: "Manual control for recurring invoices → auto-generation with overrides",
          impact: "Time saved 15 hours/week per user, admin complaints ↓90%",
          learning: "Smart defaults beat endless customization for small businesses",
          metrics: "15 hrs/week saved, 90% fewer complaints"
        }
      ]
    },
    aiCollaboration: {
      ...
      aiHandled: [
        "Analyzed 3 years of error logs → surfaced 12 high-cost error patterns",
        "Generated smart templates for 20 most common business workflows",
        "Synthesized 47 small business interviews → identified priority blindness patterns"
      ],
      humanRefined: [
        "Designed validation rules addressing top 5 error patterns",
        "Created Today dashboard with priority scoring based on urgency + impact",
        "Built progressive automation that learned from user behavior"
      ],
      combinedImpact: {
        timeSaved: "Admin time ↓65% (from 12 hrs/week to 4 hrs/week)",
        qualityImproved: "Error prevention ↑68%, support tickets ↓45%"
      }
    },
    distributionDesign: {
      title: "Self-Service Growth Loops",
      moments: [
        {
          feature: "Invite teammate at end of setup",
          mechanism: "Prompt after first successful workflow completion",
          result: "32% sent team invites → team adoption +40% within 30 days"
        },
        {
          feature: "Mobile-first design for field work",
          mechanism: "Responsive forms work on any device, anywhere",
          result: "Mobile usage +55% → accessibility drove adoption"
        },
        {
          feature: "Client invoice branding",
          mechanism: "Professional invoices with business logo = free marketing",
          result: "Clients asked about the platform → 18 organic signups from invoices"
        }
      ]
    },
    operationalArtifacts: {
      title: "Enterprise Enablement Package",
      deliverables: [
        "Admin training program: 6-hour certification course for system administrators",
        "API documentation: 47 endpoints for ERP system integrations",
        "Migration playbook: Step-by-step guide from legacy tools (Excel, QuickBooks, etc.)",
        "Video tutorial library: 25 short videos covering common workflows",
        "Sales demo deck: 12-slide presentation for enterprise prospects"
      ]
    },
    systemsBuilt: {
      title: "Compounding Systems Leverage",
      systems: [
        {
          name: "Centralized Validation Library",
          description: "Reusable validation rules across all business workflows",
          impact: "Eliminated 3 bug classes, dev velocity +25%, QA time ↓50%"
        },
        {
          name: "Form Builder Framework",
          description: "Modular system for creating business workflows without code",
          impact: "New workflows ship in 2 days vs 8 days → 4× velocity on custom features"
        },
        {
          name: "Smart Template Engine",
          description: "AI-powered templates that adapt to business patterns",
          impact: "Template usage 85% → consistency improved, errors eliminated"
        }
      ]
    },
    customerVoice: [
      {
        quote: "We finally trust the numbers we show regulators. No more second-guessing before submissions.",
      ...
      {
        quote: "My admin day disappeared. Everything just happens automatically now. I have my weekends back.",
  ...
  barskyjoint: {
    ...
    strategicDecisions: {
      title: "Dual-Interface Trade-Off Decision",
      decisions: [
        {
          chose: "Dual-interface over unified dashboard",
          sacrificed: "2× development time → separate server/kitchen views",
          impact: "Error rate ↓60%, order speed +35%",
          learning: "Context-specific UIs beat unified dashboards in operational environments",
          metrics: "60% fewer errors, 35% faster"
        },
        {
          chose: "Guided customization over complete freedom",
          sacrificed: "Advanced customization options → smart defaults with overrides",
          impact: "Abandonment ↓45%, ticket size +28%",
          learning: "Less choice = more completion when decision fatigue is high",
          metrics: "45% less abandonment, 28% higher tickets"
        }
      ]
    },
    aiCollaboration: {
      title: "AI-Powered Menu Intelligence",
      aiHandled: [
        "Analyzed 500+ order error logs → identified 8 miscommunication patterns",
        "Generated 40+ menu description variants for clarity testing",
        "Synthesized customer interviews → identified decision paralysis triggers"
      ],
      humanRefined: [
        "Designed visual cues eliminating top 5 communication patterns",
        "A/B tested descriptions, chose clarity over marketing language",
        "Created progressive disclosure flows preventing overwhelm"
      ],
      combinedImpact: {
        timeSaved: "Menu optimization time ↓80% (from 6 weeks to 1 week)",
        qualityImproved: "Order errors ↓60%, kitchen-server conflict ↓45%"
      }
    },
    distributionDesign: {
      title: "Restaurant Growth Mechanisms",
      moments: [
        {
          feature: "Server referral program",
          mechanism: "Refer restaurant, get $50 bonus after 100 orders",
          result: "20% referred peers → new client CAC ↓$120 per restaurant"
        },
        {
          feature: "QR code ordering during COVID",
          mechanism: "Table-side ordering without touching menus or tablets",
          result: "80% customer adoption → contactless trend captured early"
        },
        {
          feature: "Upsell intelligence",
          mechanism: "Smart suggestions based on popular pairings",
          result: "Ticket size +28% → restaurants saw immediate ROI"
        }
      ]
    },
    operationalArtifacts: {
      title: "Restaurant Success Package",
      deliverables: [
        "Staff training videos: 5× Loom tutorials (avg 90 seconds each) for servers and kitchen",
        "POS integration guide: 35 pages covering 8 major systems (Toast, Square, Clover, etc.)",
        "Launch comms: Email campaign → 300 restaurant demo requests in first month",
        "Menu optimization playbook: 15-page guide for maximizing ticket size",
        "Support documentation: 20 common troubleshooting scenarios with solutions"
      ]
    },
    systemsBuilt: {
      title: "Scalable Restaurant Tech",
      systems: [
        {
          name: "Order Status Component Library",
          description: "Reusable UI components across web/tablet/kiosk interfaces",
          impact: "Development time ↓50%, consistent experience across all touchpoints"
        },
        {
          name: "Real-Time Sync Architecture",
          description: "WebSocket-based order sync between kitchen, server, and customer displays",
          impact: "Eliminated 'order lost' bugs entirely → 0 sync failures in 6 months"
        },
        {
          name: "Menu Configuration Engine",
          description: "No-code menu builder for restaurants to update offerings",
          impact: "Restaurant self-service 95% → support tickets ↓70%"
        }
      ]
    },
    customerVoice: [
      {
        quote: "We finally stopped losing orders between the front and back. Staff morale is way up, and customers are happier.",
        author: "Chef David Martinez",
        title: "Restaurant Owner",
        metric: "60%",
        metricLabel: "Fewer order errors"
      },
      {
        quote: "The upsell suggestions feel natural, not pushy. Our ticket size went up without customers feeling pressured.",
        author: "Maria Santos",
        title: "Server & Manager",
        metric: "28%",
        metricLabel: "Higher ticket size"
      }
    ],
    sections: [],
    seoData: {
