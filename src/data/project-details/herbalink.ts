...
export const herbalinkDetails: ProjectDetails = {
  ...
  // Competitive analysis text that will appear between overview and challenge images
  challengeAdditionalText: "Competitive Analysis:\nAnalyzed BetterHelp, Headspace Health, and Zocdoc to identify opportunities for differentiation in the herbal wellness space.\n\nKey Insights: The analysis revealed no platforms specifically designed for herbalist consultations, creating an opportunity for specialized intake forms tailored to herbal needs and education-focused features that build user confidence in natural wellness approaches.\n\nMany people face challenges such as unreliable information and inconsistent or unsafe online advice, which can lead to confusion and potential harm. Additionally, locating trusted practitioners, including herbalists, remains difficult, making it hard to find reputable experts when needed. There is also a notable lack of effective tools for tracking progress, leaving individuals unable to monitor their health effectively. Furthermore, poor interface design and complex platforms often overwhelm people, hindering their ability to navigate and utilize resources efficiently.",
