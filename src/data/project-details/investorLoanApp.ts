...
export const investorLoanAppDetails: ProjectDetails = {
  ...
  technologies: ["User Research", "Figma", "Balsamiq", "AG Grid", "Predictive AI Search", "Banking Product Design", "Financial Data Visualization", "Excel Automation", "Order Management Systems"],
  duration: "1.5 years",
