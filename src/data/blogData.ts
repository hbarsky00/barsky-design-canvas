...
// The seven AI/tooling posts carried forward from main (2026-09-24). They were
// live and indexed off the Aug 7 build; the May 15 restore dropped them, which
// would have 404'd seven indexed URLs on deploy. Covers and inline images came
// across with them under src/assets/blog/.
