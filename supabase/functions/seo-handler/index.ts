...
const PROJECT_SEO: Record<string, { title: string; description: string; image: string }> = {
  smarterhealth: { title: "Smarter Health | Healthcare App UX Case Study — Barsky Design", description: "Healthcare app that made medication tracking 45% faster and appointment adherence 60% higher.", image: "https://barskydesign.pro/images/og-image.png" },
  crypto: { title: "Crypto Trading Platform | Fintech UX Case Study — Barsky Design", description: "How I eliminated the fear that makes 60% of beginners quit before their first trade.", image: "https://barskydesign.pro/images/crypto/hero.jpg" },
  herbalink: { title: "HerbaLink Healthcare Marketplace | UX Case Study — Barsky Design", description: "HIPAA-compliant herbalist marketplace design that increased certified provider bookings 45%.", image: "https://barskydesign.pro/images/herbalink/home-2026.jpg" },
  splittime: { title: "SplitTime Co-Parenting App | Mobile UX Case Study — Barsky Design", description: "Designing a co-parenting platform that reduces family conflict through intuitive scheduling.", image: "https://barskydesign.pro/images/splittime/hero.jpg" },
  "business-management": { title: "Enterprise Operations Platform | B2B UX Case Study — Barsky Design", description: "Modular business management platform that reduced manual work 60%.", image: "https://barskydesign.pro/images/business-management/hero-three-laptops.jpg" },
  "investor-loan-app": { title: "Fintech Loan Platform | Investment App UX Case Study — Barsky Design", description: "Streamlined fintech underwriting that cut loan processing time 40%.", image: "https://barskydesign.pro/images/investor-loan-app/hero.png" },
  "dae-search": { title: "Enterprise Data Discovery | Search UX Case Study — Barsky Design", description: "Advanced search platform that helps data analysts find assets 3x faster.", image: "https://barskydesign.pro/images/dae-search/hero.jpg" },
...
const BLOG_SEO: Record<string, { title: string; description: string; image: string }> = {
  "two-bugs-ai-wrote-that-i-had-to-find": { title: "Two Bugs AI Wrote That I Had to Find Myself — Barsky Design", description: "A model with no clock and a database that answers empty instead of erroring. Two real bugs from shipping AI-generated code.", image: "https://barskydesign.pro/blog-ai-in-design.jpg" },
  "taste-is-the-whole-job": { title: "When Generating Is Free, Taste Is the Whole Job — Barsky Design", description: "When anyone can generate a hundred options, the job stops being production and becomes knowing which one to keep.", image: "https://barskydesign.pro/blog-visual-hierarchy.jpg" },
  "designer-who-codes-argument-is-over": { title: "The Designer Who Codes Argument Is Over — Barsky Design", description: "The debate ended because the cost of shipping fell far enough that the question stopped mattering.", image: "https://barskydesign.pro/blog-design-systems.jpg" },
  "shipping-got-cheap-hiring-got-harder": { title: "Shipping Got Cheap. Hiring Got Harder. — Barsky Design", description: "What the design job market looks like now that building a product is no longer the hard part.", image: "https://barskydesign.pro/blog-finding-ux-job.jpg" },
  "everyones-portfolio-looks-good-now": { title: "Everyone's Portfolio Looks Good Now — Barsky Design", description: "Polish stopped being a signal. What a portfolio has to prove instead.", image: "https://barskydesign.pro/blog-case-study-writing.jpg" },
  "what-ai-changed-and-what-it-didnt": { title: "What AI Changed About Design Work, and What It Didn't — Barsky Design", description: "An honest split between the parts of the job AI genuinely took over and the parts it never touched.", image: "https://barskydesign.pro/blog-user-research-budget.jpg" },
};
